...
ggplot(data = vv_am_scale_n, aes(x = ANOMES)) +
  geom_line(aes(y = QP.sd), col = 'orange', size = 1.1, group = 1, show.legend = TRUE) +
  geom_line(aes(y = VT.sd), col = 'blue', size = 1.1, group = 1, show.legend = T) +
  labs(title = 'Avaliação Padronizada de Volume x Valores',
       x = 'Ano e Mês',
       y = 'Desvios Padrão') +
  theme_dark() +
