...
f.print_corr <- function(df){
  dfo <- data.frame(cat = as.character(), cor = as.double()) ## Mudança de objeto pois "tibble 3.0" apresentou erro
...
cat("Gráfico de exemplo para referÊncia")
...
ds_COR_estado %<>% arrange(desc(cor))           # Novo
                                                #
print(f.mplot(ds_COR_estado[1:10,], "Estado"))  #
print(f.mplot(ds_COR_estado[11:20,], "Estado")) #
print(f.mplot(ds_COR_estado[21:25,], "Estado")) #

print(f.mplot(ds_COR_conceito, "Conceito"))
print(f.mplot(ds_COR_dependencia, "Dependencia"))
print(f.mplot(ds_COR_modalidade, "Modalidade"))
print(f.mplot(ds_COR_grau, "Grau"))     # Novo
