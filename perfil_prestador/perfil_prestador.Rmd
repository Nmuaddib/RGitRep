...
### Setup e conexão com o BI/BD Top Saude
...
```{sql connection=con, echo=TRUE, output.var="x_tab_habilitacao"}
...
```{sql connection=con, echo=TRUE, output.var="x_tab_ben_vlr_apr"}
...
```{sql connection=con, echo=TRUE, output.var="x_tab_tratamento"}
select  dp.COD_PRESTADOR_TS codigo,
        dp.NOME_PRESTADOR nome,
...
```{sql connection=con, echo=TRUE, output.var="x_tab_especialidade"}
select  dp.COD_PRESTADOR_TS codigo,
        dp.NOME_PRESTADOR nome,
...
```{sql connection=con, echo=TRUE, output.var="x_tab_detalhamento"}
select  dp.COD_PRESTADOR_TS codigo,
        dp.NOME_PRESTADOR nome,
        di.NOME_ESPECIALIDADE especialidade,
        di.NOME_ITEM item,
...
```{sql connection=con, echo=TRUE, output.var="x_tab_itens"}
select  dp.COD_PRESTADOR_TS codigo,
        dp.NOME_PRESTADOR nome,
        di.ITEM_MEDICO,
        di.NOME_ITEM item,
...
```{sql connection=con, echo=TRUE, output.var="x_tab_cotas"}
select ps.num_insc_fiscal,
       ps.nome_prestador,
...
write.csv2(tab_s_detalhamento, 'tab_detalhamento.csv')
##-----------------------------------------------------------------------------------------------------
